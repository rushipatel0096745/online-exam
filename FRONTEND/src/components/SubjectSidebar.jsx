        ...
        <div
            ...
            <Stack
                ...
                <div>
                    ...
                    <small className='text-secondary'>{subjects?.length || 0} total</small>
                </div>

                <Button size='sm' variant='outline-light' onClick={onAddSubject}>
                    + Add
                </Button>
            </Stack>
                            ...
                            return (
                                <ListGroup.Item
                                    ...
                                    <div className='d-flex flex-column'>
                                        <span className='fw-medium text-truncate'>{subject.name}</span>
